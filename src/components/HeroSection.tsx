...
export function HeroSection() {
  ...
  useGSAP(() => {
    ...
    const initAnimation = () => {
      ...
      // Single scrubbed timeline — drives video + all three phrase reveals
      ...
      // Video scrub: proxy avoids direct tween of read-only currentTime
      const proxy = { t: 0 }
      tl.to(
        proxy,
        {
      ...
      // WE GROW — scroll 0–33% (timeline 0s–1s)
      tl.fromTo(
        phrase1Ref.current,
    ...
    >
      <div className="flex h-screen w-full">
        ...
        <div className="flex flex-1 flex-col justify-center px-12 md:px-20 gap-8">
          ...
          {/* Phrase stack — all visible, pending phrases start ghosted + clipped */}
        ...
        {/* Right column — mascot video (desktop only) */}
